...
public class LoginServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String sql = "SELECT * FROM usuarios WHERE username=? AND passwd=?";
        ...
        try {
            ...
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:8889/mensajeria", "root", "root");
